...
def set_all_entrance_and_location_rules(world: ManicMinersWorld) -> None:
    ...
    if world.options.crystal_targets_are_locations:
        ...
        location_crystals_lrr_breathless = world.get_location("Crystal Target: LRR - Breathless")
        location_crystals_lrr_dontpanic = world.get_location("Crystal Target: LRR - Don't Panic")
        location_crystals_lrr_drillernight = world.get_location("Crystal Target: LRR - Driller Night")
        ...
        location_crystals_lrr_icespy = world.get_location("Crystal Target: LRR - Ice Spy")
        ...
        location_crystals_lrr_rubbletrouble = world.get_location("Crystal Target: LRR - Rubble Trouble")
        location_crystals_lrr_runthegauntlet = world.get_location("Crystal Target: LRR - Run The Gauntlet")
        location_crystals_lrr_searchandrescue = world.get_location("Crystal Target: LRR - Search And Rescue")
        location_crystals_lrr_splitdownthemiddle = world.get_location("Crystal Target: LRR - Split Down The Middle")
    ...
    if world.options.crystal_targets_are_locations:
        ...
        location_crystals_lrrr_breathless = world.get_location("Crystal Target: LRRR - Breathless")
        location_crystals_lrrr_dontpanic = world.get_location("Crystal Target: LRRR - Don't Panic")
        location_crystals_lrrr_drillernight = world.get_location("Crystal Target: LRRR - Driller Night")
        location_crystals_lrrr_erodeworks = world.get_location("Crystal Target: LRRR - Erode Works")
        location_crystals_lrrr_explosiveaction = world.get_location("Crystal Target: LRRR - Explosive Action")
        ...
        location_crystals_lrrr_runthegauntlet = world.get_location("Crystal Target: LRRR - Run The Gauntlet")
        ...
        location_crystals_lrrr_waterlotoffun = world.get_location("Crystal Target: LRRR - Water Lot Of Fun")
    ...
    if world.options.crystal_targets_are_locations:
        location_crystals_lrrc_abreathoffreshair = world.get_location("Crystal Target: LRRC - A Breath Of Fresh Air")
        location_crystals_lrrc_airraiders = world.get_location("Crystal Target: LRRC - Air Raiders")
        ...
        location_crystals_lrrc_dontpanic = world.get_location("Crystal Target: LRRC - Don't Panic")
        location_crystals_lrrc_drillernight = world.get_location("Crystal Target: LRRC - Driller Night")
        location_crystals_lrrc_erodeworks = world.get_location("Crystal Target: LRRC - Erode Works")
        location_crystals_lrrc_explosiveaction = world.get_location("Crystal Target: LRRC - Explosive Action")
        location_crystals_lrrc_fireandwater = world.get_location("Crystal Target: LRRC - Fire And Water")
        location_crystals_lrrc_frozenfrenzy = world.get_location("Crystal Target: LRRC - Frozen Frenzy")
        location_crystals_lrrc_hotstuff = world.get_location("Crystal Target: LRRC - Hot Stuff")
        location_crystals_lrrc_icespy = world.get_location("Crystal Target: LRRC - Ice Spy")
        ...
        location_crystals_lrrc_oresome = world.get_location("Crystal Target: LRRC - Oresome")
        ...
        location_crystals_lrrc_rubbletrouble = world.get_location("Crystal Target: LRRC - Rubble Trouble")
        location_crystals_lrrc_runthegauntlet = world.get_location("Crystal Target: LRRC - Run The Gauntlet")
        location_crystals_lrrc_searchandrescue = world.get_location("Crystal Target: LRRC - Search And Rescue")
        location_crystals_lrrc_splitdownthemiddle = world.get_location("Crystal Target: LRRC - Split Down The Middle")
