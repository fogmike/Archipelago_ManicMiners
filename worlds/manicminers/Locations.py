...
BONUS_LOCATIONS_CLEAR = {
    "LRR - A Breath Of Fresh Air": 1,
    "LRR - Air Raiders": 3,
    "LRR - Back To Basics": 4,
    "LRR - Breathless": 2,
    "LRR - Don't Panic": 3,
    "LRR - Driller Night": 1,
    "LRR - Erode Works": 2,
    "LRR - Explosive Action": 1,
    "LRR - Fire And Water": 3,
    "LRR - Frozen Frenzy": 2,
    "LRR - Hot Stuff": 4,
    "LRR - Ice Spy": 3,
    "LRR - It's A Hold Up": 1,
    "LRR - Lake Of Fire": 3,
    "LRR - Lava Laughter": 3,
    "LRR - Oresome": 3,
    "LRR - Rock Hard": 2,
    "LRR - Rocky Horror": 4,
    "LRR - Rubble Trouble": 1,
    "LRR - Run The Gauntlet": 1,
    "LRR - Search And Rescue": 2,
    "LRR - Split Down The Middle": 2,
    "LRR - The Path To Power": 1,
    "LRR - Water Lot Of Fun": 2,
    "LRR - Water Works": 2,
    
    "LRRR - A Breath Of Fresh Air": 1,
    "LRRR - Air Raiders": 3,
    "LRRR - Back To Basics": 4,
    "LRRR - Breathless": 2,
    "LRRR - Don't Panic": 3,
    "LRRR - Driller Night": 1,
    "LRRR - Erode Works": 2,
    "LRRR - Explosive Action": 1,
    "LRRR - Fire And Water": 3,
    "LRRR - Frozen Frenzy": 2,
    "LRRR - Hot Stuff": 4,
    "LRRR - Ice Spy": 3,
    "LRRR - It's A Hold Up": 1,
    "LRRR - Lake Of Fire": 3,
    "LRRR - Lava Laughter": 3,
    "LRRR - Oresome": 3,
    "LRRR - Rock Hard": 2,
    "LRRR - Rocky Horror": 4,
    "LRRR - Rubble Trouble": 1,
    "LRRR - Run The Gauntlet": 1,
    "LRRR - Search And Rescue": 2,
    "LRRR - Split Down The Middle": 2,
    "LRRR - The Path To Power": 1,
    "LRRR - Water Lot Of Fun": 2,
    "LRRR - Water Works": 2,
    
    "LRRC - A Breath Of Fresh Air": 1,
    "LRRC - Air Raiders": 3,
    "LRRC - Back To Basics": 4,
    "LRRC - Breathless": 2,
    "LRRC - Don't Panic": 3,
    "LRRC - Driller Night": 1,
    "LRRC - Erode Works": 2,
    "LRRC - Explosive Action": 1,
    "LRRC - Fire And Water": 3,
    "LRRC - Frozen Frenzy": 2,
    "LRRC - Hot Stuff": 4,
    "LRRC - Ice Spy": 3,
    "LRRC - It's A Hold Up": 1,
    "LRRC - Lake Of Fire": 3,
    "LRRC - Lava Laughter": 3,
    "LRRC - Oresome": 3,
    "LRRC - Rock Hard": 2,
    "LRRC - Rocky Horror": 4,
    "LRRC - Rubble Trouble": 1,
    "LRRC - Run The Gauntlet": 1,
    "LRRC - Search And Rescue": 2,
    "LRRC - Split Down The Middle": 2,
    "LRRC - The Path To Power": 1,
    "LRRC - Water Lot Of Fun": 2,
    "LRRC - Water Works": 2,
    
    "BAZ - A Breath Of Fresh Air": 1,
    "BAZ - Air Raiders": 3,
    "BAZ - Back To Basics": 4,
    "BAZ - Breathless": 2,
    "BAZ - Cold Comfort": 2,
    "BAZ - Don't Panic": 3,
    "BAZ - Down In The Dirt": 2,
    "BAZ - Driller Night": 1,
    "BAZ - Erode Works": 2,
    "BAZ - Explosive Action": 1,
    "BAZ - Fire And Water": 3,
    "BAZ - Frozen Frenzy": 2,
    "BAZ - Hot Stuff": 4,
    "BAZ - Ice Spy": 3,
    "BAZ - It's A Hold Up": 1,
    "BAZ - Lake Of Fire": 3,
    "BAZ - Lava Laughter": 3,
    "BAZ - Mine Over Manner": 1,
    "BAZ - Molten Meltdown": 1,
    "BAZ - Oresome": 3,
    "BAZ - Recruitment": 1,
    "BAZ - Rock Hard": 2,
    "BAZ - Rocky Horror": 4,
    "BAZ - Rubble Trouble": 1,
    "BAZ - Run The Gauntlet": 1,
    "BAZ - Seamless": 2,
    "BAZ - Search And Rescue": 2,
    "BAZ - Slimey Simple": 2,
    "BAZ - Split Down The Middle": 2,
    "BAZ - The Hard Rock Life": 1,
    "BAZ - The Path To Power": 1,
    "BAZ - Water Lot Of Fun": 2,
    "BAZ - Water Works": 2
}
...
def create_all_locations(world: ManicMinersWorld) -> None:
    ...
    # Special Rule event handling - but since they're events, should make them in Locations not in Rules
    
    region_menu.add_event("Can Build Tool Store", "Can Build Tool Store", (Filtered(HasAny("Building Unlock: Tool Store","Progressive Building Unlock: Tool Store"), options = [OptionFilter(ManicMiners_Options.BuildingsAreItems, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Teleport Pad", "Can Build Teleport Pad", (Filtered(HasAny("Building Unlock: Teleport Pad","Progressive Building Unlock: Teleport Pad") & HasAny("Building Unlock: Power Station","Progressive Building Unlock: Power Station"), options = [OptionFilter(ManicMiners_Options.BuildingsAreItems, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Power Station", "Can Build Power Station", (Filtered(Has("Can Build Teleport Pad"), options = [OptionFilter(ManicMiners_Options.BuildingsAreItems, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Docks", "Can Build Docks", (Filtered(Has("Building Unlock: Docks") & Has("Can Build Power Station"), options = [OptionFilter(ManicMiners_Options.BuildingsAreItems, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    if world.options.campaign_selection_lrrr or world.options.campaign_selection_baz:
        region_menu.add_event("Can Build Canteen", "Can Build Canteen", (Filtered(HasAny("Building Unlock: Canteen","Progressive Building Unlock: Canteen"), options = [OptionFilter(ManicMiners_Options.BuildingsAreItems, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Support Station", "Can Build Support Station", (Filtered(HasAny("Building Unlock: Support Station","Progressive Building Unlock: Support Station") & Has("Can Build Power Station"), options = [OptionFilter(ManicMiners_Options.BuildingsAreItems, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build 2 Support Stations", "Can Build 2 Support Stations", (Filtered((Has("Building Unlock: Support Station") | Has("Progressive Building Unlock: Support Station",2)) & Has("Can Build Power Station"), options = [OptionFilter(ManicMiners_Options.BuildingsAreItems, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build 3 Support Stations", "Can Build 3 Support Stations", (Filtered((Has("Building Unlock: Support Station") | Has("Progressive Building Unlock: Support Station",3)) & Has("Can Build Power Station"), options = [OptionFilter(ManicMiners_Options.BuildingsAreItems, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    if world.options.campaign_selection_lrrr or world.options.campaign_selection_baz:
        region_menu.add_event("Can Build Geological Center", "Can Build Geological Center", (Filtered(Has("Building Unlock: Geological Center") & Has("Can Build Power Station"), options = [OptionFilter(ManicMiners_Options.BuildingsAreItems, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Upgrade Station", "Can Build Upgrade Station", (Filtered(Has("Building Unlock: Upgrade Station") & Has("Can Build Power Station"), options = [OptionFilter(ManicMiners_Options.BuildingsAreItems, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    if world.options.campaign_selection_lrrr or world.options.campaign_selection_baz:
        region_menu.add_event("Can Build Ore Refinery", "Can Build Ore Refinery", (Filtered(Has("Building Unlock: Ore Refinery") & Has("Can Build Power Station"), options = [OptionFilter(ManicMiners_Options.BuildingsAreItems, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Mining Laser", "Can Build Mining Laser", (Filtered(HasAny("Building Unlock: Mining Laser","Progressive Building Unlock: Mining Laser") & Has("Can Build Support Station"), options = [OptionFilter(ManicMiners_Options.BuildingsAreItems, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Super Teleport", "Can Build Super Teleport", (Filtered(Has("Building Unlock: Super Teleport") & Has("Can Build Support Station"), options = [OptionFilter(ManicMiners_Options.BuildingsAreItems, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Breathe", "Can Breathe", (Has("Can Build Support Station")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Always Breathe", "Can Always Breathe", (Filtered(Has("Can Breathe"), options = [OptionFilter(ManicMiners_Options.BreathingAlwaysInLogic, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Small Digger", "Can Build Small Digger", (Filtered(HasAny("Vehicle Unlock: Small Digger","Progressive Vehicle Unlock: Small Digger"), options = [OptionFilter(ManicMiners_Options.VehiclesAreItems, 1)], filtered_resolution = True) & Has("Can Build Support Station") & Filtered(Has("Can Build Upgrade Station"), options = [OptionFilter(ManicMiners_Options.FasterBlastingAlwaysInLogic, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    if world.options.campaign_selection_lrrr or world.options.campaign_selection_baz:
        region_menu.add_event("Can Build Small Transport Truck", "Can Build Small Transport Truck", (Filtered(HasAny("Vehicle Unlock: Small Transport Truck","Progressive Vehicle Unlock: Small Transport Truck"), options = [OptionFilter(ManicMiners_Options.VehiclesAreItems, 1)], filtered_resolution = True) & Has("Can Build Support Station")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Small Mobile Laser Cutter", "Can Build Small Mobile Laser Cutter", (Filtered(HasAny("Vehicle Unlock: Small Mobile Laser Cutter","Progressive Vehicle Unlock: Small Mobile Laser Cutter"), options = [OptionFilter(ManicMiners_Options.VehiclesAreItems, 1)], filtered_resolution = True) & Has("Can Build Support Station") & Filtered(Has("Can Build Upgrade Station"), options = [OptionFilter(ManicMiners_Options.FasterBlastingAlwaysInLogic, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Rapid Rider", "Can Build Rapid Rider", (Has("Can Build Docks") & Filtered(HasAny("Vehicle Unlock: Rapid Rider","Progressive Vehicle Unlock: Rapid Rider"), options = [OptionFilter(ManicMiners_Options.VehiclesAreItems, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Cargo Carrier", "Can Build Cargo Carrier", (Has("Can Build Docks") & Filtered(HasAny("Vehicle Unlock: Cargo Carrier","Progressive Vehicle Unlock: Cargo Carrier"), options = [OptionFilter(ManicMiners_Options.VehiclesAreItems, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Tunnel Scout", "Can Build Tunnel Scout", (Has("Can Build Teleport Pad") & Filtered(HasAny("Vehicle Unlock: Tunnel Scout","Progressive Vehicle Unlock: Tunnel Scout"), options = [OptionFilter(ManicMiners_Options.VehiclesAreItems, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Tunnel Transport", "Can Build Tunnel Transport", (Has("Can Build Super Teleport") & Filtered(HasAny("Vehicle Unlock: Tunnel Transport","Progressive Vehicle Unlock: Tunnel Transport"), options = [OptionFilter(ManicMiners_Options.VehiclesAreItems, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    if world.options.campaign_selection_lrrr or world.options.campaign_selection_baz:
        region_menu.add_event("Can Build Hover Scout", "Can Build Hover Scout", (Has("Can Build Teleport Pad") & Filtered(HasAny("Vehicle Unlock: Hover Scout","Progressive Vehicle Unlock: Hover Scout"), options = [OptionFilter(ManicMiners_Options.VehiclesAreItems, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Granite Grinder", "Can Build Granite Grinder", (Has("Can Build Super Teleport") & Filtered(HasAny("Vehicle Unlock: Granite Grinder","Progressive Vehicle Unlock: Granite Grinder"), options = [OptionFilter(ManicMiners_Options.VehiclesAreItems, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Large Mobile Laser Cutter", "Can Build Large Mobile Laser Cutter", (Has("Can Build Super Teleport") & Filtered(HasAny("Vehicle Unlock: Large Mobile Laser Cutter","Progressive Vehicle Unlock: Large Mobile Laser Cutter"), options = [OptionFilter(ManicMiners_Options.VehiclesAreItems, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Chrome Crusher", "Can Build Chrome Crusher", (Has("Can Build Super Teleport") & Filtered(HasAny("Vehicle Unlock: Chrome Crusher","Progressive Vehicle Unlock: Chrome Crusher"), options = [OptionFilter(ManicMiners_Options.VehiclesAreItems, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Use Dynamite", "Can Use Dynamite", (Filtered(Has("Item Unlock: Dynamite"), options = [OptionFilter(ManicMiners_Options.ItemsAreItems, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    if world.options.campaign_selection_lrrr or world.options.campaign_selection_baz or world.options.electric_fences_in_logic:
        region_menu.add_event("Can Build Electric Fence", "Can Build Electric Fence", (Filtered(Has("Item Unlock: Electric Fence"), options = [OptionFilter(ManicMiners_Options.ItemsAreItems, 1)], filtered_resolution = True) & Has("Can Build Power Station")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Jumping Vehicle", "Can Build Jumping Vehicle", (Has("Can Build Hover Scout") | Has("Can Build Granite Grinder")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Flying Vehicle", "Can Build Flying Vehicle", (Has("Can Build Tunnel Scout") | Has("Can Build Tunnel Transport")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Swimming Vehicle", "Can Build Swimming Vehicle", (Has("Can Build Flying Vehicle") | Has("Can Build Rapid Rider") | Has("Can Build Cargo Carrier")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Laser Vehicle", "Can Build Laser Vehicle", (Has("Can Build Small Mobile Laser Cutter") | Has("Can Build Large Mobile Laser Cutter") | Has("Can Build Chrome Crusher")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Use Laser", "Can Use Laser", (Has("Can Build Laser Vehicle") | Has("Can Build Mining Laser")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Use Laser From Flying Vehicle", "Can Use Laser From Flying Vehicle", (Has("Can Build Laser Vehicle") & Has("Can Build Tunnel Transport")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Mine From Flying Vehicle", "Can Mine From Flying Vehicle", ((Has("Can Build Tunnel Scout") & Has("Can Build Upgrade Station")) | Has("Can Use Laser From Flying Vehicle")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Mine From Swimming Vehicle", "Can Mine From Swimming Vehicle", ((Has("Can Mine From Flying Vehicle") | Has("Can Build Rapid Rider"))), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Mine Hard Rock Cheaply", "Can Mine Hard Rock Cheaply", (Has("Can Use Dynamite") | Has("Can Build Small Digger") | Has("Can Build Small Mobile Laser Cutter") | Has("Can Build Mining Laser")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Mine Hard Rock", "Can Mine Hard Rock", (Has("Can Use Dynamite") | Has("Can Use Laser") | Has("Can Build Small Digger") | Has("Can Build Granite Grinder")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Mine Hard Rock Efficiently", "Can Mine Hard Rock Efficiently", (Has("Can Build Granite Grinder") | Has("Can Build Large Mobile Laser Cutter") | Has("Can Build Chrome Crusher")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Mine Hard Rock Across Water", "Can Mine Hard Rock Across Water", ((Has("Can Build Cargo Carrier") & (Has("Can Build Small Digger") | Has("Can Build Small Mobile Laser Cutter"))) | (Has("Can Build Tunnel Transport") & (Has("Can Use Laser") | Has("Can Build Small Digger") | Has("Can Build Granite Grinder"))) | (Has("Can Build Swimming Vehicle") & Has("Can Mine Hard Rock") & Has("Can Build Tool Store"))), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build 10 Miners", "Can Build 10 Miners", (Filtered(Has("Miner Cap +5",1), options = [OptionFilter(ManicMiners_Options.MinerCap, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build 20 Miners", "Can Build 20 Miners", (Has("Can Build 2 Support Stations") & Filtered(Has("Miner Cap +5",3), options = [OptionFilter(ManicMiners_Options.MinerCap, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build 30 Miners", "Can Build 30 Miners", (Has("Can Build 3 Support Stations") & Filtered(Has("Miner Cap +5",5), options = [OptionFilter(ManicMiners_Options.MinerCap, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    
    # Rest of the actual Locations and level-specific Events
