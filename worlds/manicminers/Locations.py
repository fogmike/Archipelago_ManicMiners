...
def create_all_locations(world: ManicMinersWorld) -> None:
    ...
    region_menu.add_event("Can Build Tool Store", "Can Build Tool Store", (HasAny("Building Unlock: Tool Store","Progressive Building Unlock: Tool Store")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Teleport Pad", "Can Build Teleport Pad", (HasAny("Building Unlock: Teleport Pad","Progressive Building Unlock: Teleport Pad") & HasAny("Building Unlock: Power Station","Progressive Building Unlock: Power Station")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Power Station", "Can Build Power Station", (Has("Can Build Teleport Pad")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Docks", "Can Build Docks", (Has("Building Unlock: Docks") & Has("Can Build Power Station")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    if world.options.campaign_selection_lrrr or world.options.campaign_selection_baz:
        region_menu.add_event("Can Build Canteen", "Can Build Canteen", (HasAny("Building Unlock: Canteen","Progressive Building Unlock: Canteen")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Support Station", "Can Build Support Station", (HasAny("Building Unlock: Support Station","Progressive Building Unlock: Support Station") & Has("Can Build Power Station")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build 2 Support Stations", "Can Build 2 Support Stations", ((Has("Building Unlock: Support Station") | Has("Progressive Building Unlock: Support Station",2)) & Has("Can Build Power Station")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build 3 Support Stations", "Can Build 3 Support Stations", ((Has("Building Unlock: Support Station") | Has("Progressive Building Unlock: Support Station",3)) & Has("Can Build Power Station")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    if world.options.campaign_selection_lrrr or world.options.campaign_selection_baz:
        region_menu.add_event("Can Build Geological Center", "Can Build Geological Center", (Has("Building Unlock: Geological Center") & Has("Can Build Power Station")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Upgrade Station", "Can Build Upgrade Station", (Has("Building Unlock: Upgrade Station") & Has("Can Build Power Station")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    if world.options.campaign_selection_lrrr or world.options.campaign_selection_baz:
        region_menu.add_event("Can Build Ore Refinery", "Can Build Ore Refinery", (Has("Building Unlock: Ore Refinery") & Has("Can Build Power Station")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Mining Laser", "Can Build Mining Laser", (HasAny("Building Unlock: Mining Laser","Progressive Building Unlock: Mining Laser") & Has("Can Build Support Station")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Super Teleport", "Can Build Super Teleport", (Has("Building Unlock: Super Teleport") & Has("Can Build Support Station")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    ...
    region_menu.add_event("Can Build Small Digger", "Can Build Small Digger", (HasAny("Vehicle Unlock: Small Digger","Progressive Vehicle Unlock: Small Digger") & Has("Can Build Support Station") & Filtered(Has("Can Build Upgrade Station"), options = [OptionFilter(ManicMiners_Options.FasterBlastingAlwaysInLogic, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    if world.options.campaign_selection_lrrr or world.options.campaign_selection_baz:
        region_menu.add_event("Can Build Small Transport Truck", "Can Build Small Transport Truck", (HasAny("Vehicle Unlock: Small Transport Truck","Progressive Vehicle Unlock: Small Transport Truck") & Has("Can Build Support Station")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Small Mobile Laser Cutter", "Can Build Small Mobile Laser Cutter", (HasAny("Vehicle Unlock: Small Mobile Laser Cutter","Progressive Vehicle Unlock: Small Mobile Laser Cutter") & Has("Can Build Support Station") & Filtered(Has("Can Build Upgrade Station"), options = [OptionFilter(ManicMiners_Options.FasterBlastingAlwaysInLogic, 1)], filtered_resolution = True)), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Rapid Rider", "Can Build Rapid Rider", (Has("Can Build Docks") & HasAny("Vehicle Unlock: Rapid Rider","Progressive Vehicle Unlock: Rapid Rider")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Cargo Carrier", "Can Build Cargo Carrier", (Has("Can Build Docks") & HasAny("Vehicle Unlock: Cargo Carrier","Progressive Vehicle Unlock: Cargo Carrier")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Tunnel Scout", "Can Build Tunnel Scout", (Has("Can Build Teleport Pad") & HasAny("Vehicle Unlock: Tunnel Scout","Progressive Vehicle Unlock: Tunnel Scout")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Tunnel Transport", "Can Build Tunnel Transport", (Has("Can Build Super Teleport") & HasAny("Vehicle Unlock: Tunnel Transport","Progressive Vehicle Unlock: Tunnel Transport")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    if world.options.campaign_selection_lrrr or world.options.campaign_selection_baz:
        region_menu.add_event("Can Build Hover Scout", "Can Build Hover Scout", (Has("Can Build Teleport Pad") & HasAny("Vehicle Unlock: Hover Scout","Progressive Vehicle Unlock: Hover Scout")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Granite Grinder", "Can Build Granite Grinder", (Has("Can Build Super Teleport") & HasAny("Vehicle Unlock: Granite Grinder","Progressive Vehicle Unlock: Granite Grinder")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Large Mobile Laser Cutter", "Can Build Large Mobile Laser Cutter", (Has("Can Build Super Teleport") & HasAny("Vehicle Unlock: Large Mobile Laser Cutter","Progressive Vehicle Unlock: Large Mobile Laser Cutter")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Build Chrome Crusher", "Can Build Chrome Crusher", (Has("Can Build Super Teleport") & HasAny("Vehicle Unlock: Chrome Crusher","Progressive Vehicle Unlock: Chrome Crusher")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    region_menu.add_event("Can Use Dynamite", "Can Use Dynamite", (Has("Item Unlock: Dynamite")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
    if world.options.campaign_selection_lrrr or world.options.campaign_selection_baz:
        region_menu.add_event("Can Build Electric Fence", "Can Build Electric Fence", (Has("Item Unlock: Electric Fence") & Has("Can Build Power Station")), location_type=ManicMinersLocation, item_type=Items.ManicMinersItem)
